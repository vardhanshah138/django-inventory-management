...
urlpatterns = [
    ...
    path('view_inventory_items', views.view_inventory_items, name="view_inventory_items"),
    path('update_inventory_item/<int:id>/', views.update_inventory_item, name="update_inventory_item"),
    path('delete_inventory_item/<int:id>/', views.delete_inventory_item, name="delete_inventory_item"),
